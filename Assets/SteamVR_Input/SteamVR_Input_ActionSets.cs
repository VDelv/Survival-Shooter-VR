...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_FlareGun p_FlareGun;
        ...
        public static SteamVR_Input_ActionSet_FlareGun FlareGun
        {
            get
            {
                return SteamVR_Actions.p_FlareGun.GetCopy<SteamVR_Input_ActionSet_FlareGun>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_FlareGun = ((SteamVR_Input_ActionSet_FlareGun)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_FlareGun>("/actions/FlareGun")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.FlareGun};
        }
    }
}
